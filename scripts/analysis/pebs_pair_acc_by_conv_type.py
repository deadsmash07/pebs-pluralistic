"""PEBS pair-accuracy stratified by PRISM conversation type.

Does PEBS gain differ across task types (unguided vs values-guided
...
Workflow:
  ...
  4. For each conv_type, compute pair-accuracy under raw vs PEBS-affine vs PEBS-quadratic
...
OUT_DIR = (Path(__file__).resolve().parents[2] / "3_PEBS_Standalone/results/track1_pairacc_by_convtype")
